...
public class SpaceInvaders extends JPanel implements ActionListener, KeyListener{
    ...
    int bulletVelocityY =-10; // bullet moving upwards
    ...
    SpaceInvaders(){
        ...
        //load images
        shipImg= new ImageIcon(getClass().getResource("/spaceinvaders/ship.png")).getImage();
        alienImg= new ImageIcon(getClass().getResource("/spaceinvaders/alien.png")).getImage();
        alienCyanImg= new ImageIcon(getClass().getResource("/spaceinvaders/alien-cyan.png")).getImage();
        alienMagentaImg= new ImageIcon(getClass().getResource("/spaceinvaders/alien-magenta.png")).getImage();
        alienYellowImg= new ImageIcon(getClass().getResource("/spaceinvaders/alien-yellow.png")).getImage();
    ...
    public void move(){
        ...
        while(bulletArray.size() > 0 && (bulletArray.get(0).used || bulletArray.get(0).y < 0)){
            bulletArray.remove(0);  // removes the first elements of the array
        }
